...
public:
    ...
    virtual void insert_ref_value(std::string usr, std::string filename, int fileId, int nameId, int line, int col, int kind, int refFid, int refLine, int refCol);
    virtual void insert_decl_value(std::string usr, std::string filename, int fileId, int nameId, int line, int col, int entityKind, int val, int isVirtual, int isDef, int typeUsrId, int typeKind, int isPointer);
