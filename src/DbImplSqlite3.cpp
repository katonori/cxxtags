...
void DbImplSqlite3::tryStep(sqlite3_stmt *stmt)
{
...
void DbImplSqlite3::prepareStatement(const char* queryInsertTmpl, sqlite3_stmt **sqlStmt)
{
    const char* err = NULL;
...
void DbImplSqlite3::finDb(sqlite3_stmt *sqlStmt)
{
    sqlite3_finalize(sqlStmt);
}

void DbImplSqlite3::init(std::string db_file_name, std::string src_file_name, std::string excludeList, int isPartial, int isSkel, const char* curDir, int argc, const char** argv)
{
    char *err=NULL;
...
void DbImplSqlite3::insert_ref_value(int usrId, int nameId, int fileId, int line, int col, int kind, int refFileId, int refLine, int refCol)
{
...
void DbImplSqlite3::insert_decl_value(int usrId, int nameId, int fileId, int line, int col, int entityKind, int val, int isVirtual, int isDef, int typeUsrId, int typeKind, int isPointer)
{
...
void DbImplSqlite3::insert_overriden_value(int usrId, int nameId, int fileId, int line, int col, int entityKind, int usrIdOverrider, int isDef)
{
...
void DbImplSqlite3::insert_base_class_value(int classUsrId, int baseClassUsrId, int line, int col, int accessibility)
{
...
void DbImplSqlite3::addIdList(const std::map<std::string, int >& inMap, std::string tableName)
{
    const char *err=NULL;
    sqlite3_stmt* stmt;
    std::ostringstream os;
...
void DbImplSqlite3::fin(const std::map<std::string, int >& fileMap, const std::map<std::string, int >& usrMap, const std::map<std::string, int >& nameMap)
{
