...
decl_col = "usr_list.name, name_list.name, file_list.name, decl.line, decl.col, decl.kind, decl.val, decl.is_virtual, decl.is_def, usr_list_type.name, decl.type_kind, decl.is_pointer FROM " + cxxtags.QUERY_JOINED_TABLE_DECL
...
ans_list = [
('c:@C@CParent0','CParent0',cur_dir+'/inhe.cpp',3,7,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@C@CParent0', 105, 0),
('c:@C@CParent0@F@CParent0#','CParent0',cur_dir+'/inhe.cpp',6,5,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CParent0@F@~CParent0#','~CParent0',cur_dir+'/inhe.cpp',7,5,clang.cindex.CursorKind.DESTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CParent0@F@response#','response',cur_dir+'/inhe.cpp',8,18,clang.cindex.CursorKind.CXX_METHOD.value,0,1,0, u'', 2, 0),
('c:@C@CParent0','CParent0',cur_dir+'/inhe.cpp',11,6,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',3,7),
('c:@C@CParent0@F@response#','response',cur_dir+'/inhe.cpp',11,16,clang.cindex.CursorKind.CXX_METHOD.value,0,1,1, u'', 2, 0),
('c:@C@CParent1','CParent1',cur_dir+'/inhe.cpp',15,7,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@C@CParent1', 105, 0),
('c:@C@CParent1@F@CParent1#','CParent1',cur_dir+'/inhe.cpp',18,5,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CParent1@F@~CParent1#','~CParent1',cur_dir+'/inhe.cpp',19,5,clang.cindex.CursorKind.DESTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CParent1@F@response#','response',cur_dir+'/inhe.cpp',20,18,clang.cindex.CursorKind.CXX_METHOD.value,0,1,0, u'', 2, 0),
('c:@C@CParent1','CParent1',cur_dir+'/inhe.cpp',23,6,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',15,7),
('c:@C@CParent1@F@response#','response',cur_dir+'/inhe.cpp',23,16,clang.cindex.CursorKind.CXX_METHOD.value,0,1,1, u'', 2, 0),
('c:@C@CChild','CChild',cur_dir+'/inhe.cpp',27,7,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@C@CChild', 105, 0),
('c:@C@CParent0','CParent0',cur_dir+'/inhe.cpp',28,10,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',3,7),
('c:@C@CChild@F@CChild#','CChild',cur_dir+'/inhe.cpp',31,5,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CChild@F@~CChild#','~CChild',cur_dir+'/inhe.cpp',32,5,clang.cindex.CursorKind.DESTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CChild@F@response#','response',cur_dir+'/inhe.cpp',33,18,clang.cindex.CursorKind.CXX_METHOD.value,0,1,0, u'', 2, 0),
('c:@C@CChild','CChild',cur_dir+'/inhe.cpp',36,6,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',27,7),
('c:@C@CChild@F@response#','response',cur_dir+'/inhe.cpp',36,14,clang.cindex.CursorKind.CXX_METHOD.value,0,1,1, u'', 2, 0),
('c:@C@CGChild','CGChild',cur_dir+'/inhe.cpp',40,7,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@C@CGChild', 105, 0),
('c:@C@CChild','CChild',cur_dir+'/inhe.cpp',41,10,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',27,7),
('c:@C@CGChild@F@CGChild#','CGChild',cur_dir+'/inhe.cpp',44,5,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CGChild@F@~CGChild#','~CGChild',cur_dir+'/inhe.cpp',45,5,clang.cindex.CursorKind.DESTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@CGChild@F@response#','response',cur_dir+'/inhe.cpp',46,18,clang.cindex.CursorKind.CXX_METHOD.value,0,1,0, u'', 2, 0),
('c:@C@CGChild','CGChild',cur_dir+'/inhe.cpp',49,6,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',40,7),
('c:@C@CGChild@F@response#','response',cur_dir+'/inhe.cpp',49,15,clang.cindex.CursorKind.CXX_METHOD.value,0,1,1, u'', 2, 0),
('c:@C@COther','COther',cur_dir+'/inhe.cpp',53,7,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@C@COther', 105, 0),
...
('c:@C@COther@F@COther#','COther',cur_dir+'/inhe.cpp',57,5,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@COther@F@~COther#','~COther',cur_dir+'/inhe.cpp',58,5,clang.cindex.CursorKind.DESTRUCTOR.value,0,0,1, u'', 2, 0),
('c:@C@COther@F@response#','response',cur_dir+'/inhe.cpp',59,18,clang.cindex.CursorKind.CXX_METHOD.value,0,1,0, u'', 2, 0),
('c:@C@COther','COther',cur_dir+'/inhe.cpp',62,6,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',53,7),
('c:@C@COther@F@response#','response',cur_dir+'/inhe.cpp',62,14,clang.cindex.CursorKind.CXX_METHOD.value,0,1,1, u'', 2, 0),
('c:inhe.cpp@869@F@test#*$@C@CParent0#','test',cur_dir+'/inhe.cpp',66,13,clang.cindex.CursorKind.FUNCTION_DECL.value,0,0,1, u'', 2, 0),
('c:@C@CParent0','CParent0',cur_dir+'/inhe.cpp',66,24,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',3,7),
('c:inhe.cpp@886@F@test#*$@C@CParent0#@a','a',cur_dir+'/inhe.cpp',66,34,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'c:@C@CParent0', 105, 1),
...
('c:@F@main','main',cur_dir+'/inhe.cpp',71,5,clang.cindex.CursorKind.FUNCTION_DECL.value,0,0,1, u'', 17, 0),
('c:@C@CParent0','CParent0',cur_dir+'/inhe.cpp',73,5,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',3,7),
('c:inhe.cpp@946@F@main@parent','parent',cur_dir+'/inhe.cpp',73,14,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@C@CParent0', 105, 0),
('c:@C@CChild','CChild',cur_dir+'/inhe.cpp',74,5,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',27,7),
('c:inhe.cpp@967@F@main@child','child',cur_dir+'/inhe.cpp',74,12,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@C@CChild', 105, 0),
('c:@C@CGChild','CGChild',cur_dir+'/inhe.cpp',75,5,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',40,7),
('c:inhe.cpp@985@F@main@gchild','gchild',cur_dir+'/inhe.cpp',75,13,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@C@CGChild', 105, 0),
('c:@C@COther','COther',cur_dir+'/inhe.cpp',76,5,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/inhe.cpp',53,7),
('c:inhe.cpp@1005@F@main@other','other',cur_dir+'/inhe.cpp',76,12,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@C@COther', 105, 0),
