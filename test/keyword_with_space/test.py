...
"decl "+db_dir+" "+cur_dir+"/main.cpp 23 5",
"def "+db_dir+" "+cur_dir+"/main.cpp  23 5",
"ref "+db_dir+" "+cur_dir+"/main.cpp  23 5",

"decl "+db_dir+" "+cur_dir+"/main.cpp 27 5",
"def "+db_dir+" "+cur_dir+"/main.cpp  27 5",
"ref "+db_dir+" "+cur_dir+"/main.cpp  27 5",

"decl "+db_dir+" "+cur_dir+"/main.cpp 31 5",
"def "+db_dir+" "+cur_dir+"/main.cpp  31 5",
"ref "+db_dir+" "+cur_dir+"/main.cpp  31 5",

"decl "+db_dir+" "+cur_dir+"/main.cpp 32 11",
"def "+db_dir+" "+cur_dir+"/main.cpp  32 11",
"ref "+db_dir+" "+cur_dir+"/main.cpp  32 11",
]
...
["S0|"+cur_dir+"/main.cpp|3|8|struct S0 {"],
[
'S0|'+cur_dir+r'/main.cpp|23|5|    S0 a;',
],
# 4 9
["a|"+cur_dir+"/main.cpp|4|9|    int a;"],
["a|"+cur_dir+"/main.cpp|4|9|    int a;"],
[
'a|'+cur_dir+r'/main.cpp|24|7|    a.a = 0;',
],
# 5 9
["b|"+cur_dir+"/main.cpp|5|9|    int b;"],
["b|"+cur_dir+"/main.cpp|5|9|    int b;"],
[
'b|'+cur_dir+r'/main.cpp|25|7|    a.b = 1;',
],
# 6 9
["c|"+cur_dir+"/main.cpp|6|9|    int c;"],
["c|"+cur_dir+"/main.cpp|6|9|    int c;"],
[
'c|'+cur_dir+r'/main.cpp|26|7|    a.c = 2;',
],
# 8 7
["U0|"+cur_dir+"/main.cpp|8|7|union U0 {"],
["U0|"+cur_dir+"/main.cpp|8|7|union U0 {"],
[
'U0|'+cur_dir+r'/main.cpp|27|5|    U0 b;',
],
# 9 11
["a|"+cur_dir+"/main.cpp|9|11|    int   a;"],
["a|"+cur_dir+"/main.cpp|9|11|    int   a;"],
[
'a|'+cur_dir+r'/main.cpp|28|7|    b.a = 0;',
],
# 10 11
["b|"+cur_dir+"/main.cpp|10|11|    short b;"],
["b|"+cur_dir+"/main.cpp|10|11|    short b;"],
[
'b|'+cur_dir+r'/main.cpp|29|7|    b.b = 1;',
],
# 11 11
["c|"+cur_dir+"/main.cpp|11|11|    float c;"],
["c|"+cur_dir+"/main.cpp|11|11|    float c;"],
[
'c|'+cur_dir+r'/main.cpp|30|7|    b.c = 1.0;',
],
# 22 5
["S0|"+cur_dir+"/main.cpp|3|8|struct S0 {"],
["S0|"+cur_dir+"/main.cpp|3|8|struct S0 {"],
...
["C0|"+cur_dir+"/main.cpp|13|7|class C0 {"],
[
'C0|'+cur_dir+r'/main.cpp|31|5|    C0 c;',
],
# 31 11
["EVAL|"+cur_dir+"/main.cpp|18|5|    EVAL,"],
["EVAL|"+cur_dir+"/main.cpp|18|5|    EVAL,"],
[
'EVAL|'+cur_dir+r'/main.cpp|32|11|    c.a = EVAL;',
],
]
