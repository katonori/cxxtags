...
decl_col = "usr_list.name, name_list.name, file_list.name, decl.line, decl.col, decl.kind, decl.val, decl.is_virtual, decl.is_def, usr_list_type.name, type_kind, is_pointer"
ref_col = "usr_list.name, name_list.name, file_list.name, ref.line, ref.col, ref.kind, ref_file_list.name, ref.ref_line, ref.ref_col"
...
# main.cpp
[
('c:macro@BUFF_SIZE','BUFF_SIZE','%s/main.cpp'%(cur_dir),5,9,clang.cindex.CursorKind.MACRO_DEFINITION.value,0,0,0, u'', 0, 0),
('c:@msg','msg','%s/main.cpp'%(cur_dir),6,6,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'', 112, 0),
...
('c:@F@main', 'main', '%s/main.cpp'%(cur_dir), 7, 5, clang.cindex.CursorKind.FUNCTION_DECL.value, 0,0,1, u'', 17, 0),
('c:main.cpp@127@F@main@vec','vec','%s/main.cpp'%(cur_dir),9,23,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@std@C@vector>#I#$@N@std@C@allocator>#I', 105, 0),
...
('c:main.cpp@220@F@main@c00','c00','%s/main.cpp'%(cur_dir),13,13,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@NS0@C@C0', 105, 0),
...
('c:main.cpp@240@F@main@c10','c10','%s/main.cpp'%(cur_dir),14,13,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@NS1@C@C0', 105, 0),
...
('c:main.cpp@260@F@main@c01','c01','%s/main.cpp'%(cur_dir),15,13,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@NS0@C@C1', 105, 0),
...
('c:main.cpp@280@F@main@c11','c11','%s/main.cpp'%(cur_dir),16,13,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@NS1@C@C1', 105, 0),
...
('c:main.cpp@402@F@main@i','i','%s/main.cpp'%(cur_dir),22,37,clang.cindex.CursorKind.VAR_DECL.value,0,0,1, u'c:@N@__gnu_cxx@C@__normal_iterator>#*I#$@N@std@C@vector>#I#$@N@std@C@allocator>#I', 105, 0),
...
# ns0.h
('c:@N@NS0','NS0',cur_dir+'/subdir/ns0.h',2,11,clang.cindex.CursorKind.NAMESPACE.value,0,0,1, u'', 0, 0),
('c:ns0.h@39@N@NS0@T@MYINT','MYINT',cur_dir+'/subdir/ns0.h',3,17,clang.cindex.CursorKind.TYPEDEF_DECL.value,0,0,1, u'', 17, 0),
('c:@N@NS0@C@C0','C0',cur_dir+'/subdir/ns0.h',4,11,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@N@NS0@C@C0', 105, 0),
('c:@N@NS0@C@C0@F@C0#I#','C0',cur_dir+'/subdir/ns0.h',6,9,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:ns0.h@101@N@NS0@C@C0@F@C0#I#@a','a',cur_dir+'/subdir/ns0.h',6,16,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'', 17, 0),
...
('c:@N@NS0@C@C0@F@check#','check',cur_dir+'/subdir/ns0.h',7,13,clang.cindex.CursorKind.CXX_METHOD.value,0,0,0, u'', 17, 0),
('c:@N@NS0@C@C0@FI@m_val','m_val',cur_dir+'/subdir/ns0.h',9,13,clang.cindex.CursorKind.FIELD_DECL.value,0,0,1, u'', 17, 0),
('c:@N@NS0@C@C1','C1',cur_dir+'/subdir/ns0.h',11,11,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@N@NS0@C@C1', 105, 0),
('c:@N@NS0@C@C1@F@C1#I#','C1',cur_dir+'/subdir/ns0.h',13,9,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:ns0.h@228@N@NS0@C@C1@F@C1#I#@a','a',cur_dir+'/subdir/ns0.h',13,16,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'', 17, 0),
...
('c:@N@NS0@C@C1@F@check#1','check',cur_dir+'/subdir/ns0.h',14,15,clang.cindex.CursorKind.CXX_METHOD.value,0,0,0, u'', 17, 0),
('c:@N@NS0@C@C1','C1',cur_dir+'/subdir/ns0.h',15,9,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/subdir/ns0.h',11,11),
('c:@N@NS0@C@C1@F@check2#','check2',cur_dir+'/subdir/ns0.h',15,12,clang.cindex.CursorKind.CXX_METHOD.value,0,0,0, u'c:@N@NS0@C@C1', 105, 0),
('c:@N@NS0@C@C1@FI@m_val','m_val',cur_dir+'/subdir/ns0.h',17,13,clang.cindex.CursorKind.FIELD_DECL.value,0,0,1, u'', 17, 0),
# ns1.h
('c:@N@NS1','NS1',cur_dir+'/ns1.h',2,11,clang.cindex.CursorKind.NAMESPACE.value,0,0,1, u'', 0, 0),
('c:@N@NS1@C@C0','C0',cur_dir+'/ns1.h',3,11,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@N@NS1@C@C0', 105, 0),
('c:@N@NS1@C@C0@F@C0#I#','C0',cur_dir+'/ns1.h',5,9,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:ns1.h@77@N@NS1@C@C0@F@C0#I#@a','a',cur_dir+'/ns1.h',5,16,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'', 17, 0),
...
('c:@N@NS1@C@C0@F@check#','check',cur_dir+'/ns1.h',6,14,clang.cindex.CursorKind.CXX_METHOD.value,0,0,0, u'', 2, 0),
('c:@N@NS1@C@C0@FI@m_val','m_val',cur_dir+'/ns1.h',8,13,clang.cindex.CursorKind.FIELD_DECL.value,0,0,1, u'', 17, 0),
('c:@N@NS1@C@C1','C1',cur_dir+'/ns1.h',10,11,clang.cindex.CursorKind.CLASS_DECL.value,0,0,1, u'c:@N@NS1@C@C1', 105, 0),
('c:@N@NS1@C@C1@F@C1#I#','C1',cur_dir+'/ns1.h',12,9,clang.cindex.CursorKind.CONSTRUCTOR.value,0,0,1, u'', 2, 0),
('c:ns1.h@205@N@NS1@C@C1@F@C1#I#@a','a',cur_dir+'/ns1.h',12,16,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'', 17, 0),
...
('c:@N@NS1@C@C1@F@check#','check',cur_dir+'/ns1.h',13,14,clang.cindex.CursorKind.CXX_METHOD.value,0,0,0, u'', 2, 0),
('c:@N@NS1@C@C1@FI@m_val','m_val',cur_dir+'/ns1.h',15,13,clang.cindex.CursorKind.FIELD_DECL.value,0,0,1, u'', 17, 0),
],
# ns0.cpp
[
('c:@N@NS0','NS0',cur_dir+'/ns0.cpp',2,11,clang.cindex.CursorKind.NAMESPACE.value,0,0,1, u'', 0, 0),
('c:@N@NS0@C@C0','C0',cur_dir+'/ns0.cpp',3,9,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/subdir/ns0.h',4,11),
('c:@N@NS0@C@C0@F@check#','check',cur_dir+'/ns0.cpp',3,13,clang.cindex.CursorKind.CXX_METHOD.value,0,0,1, u'', 17, 0),
...
('c:@N@NS0@C@C1@F@check#1','check',cur_dir+'/ns0.cpp',8,15,clang.cindex.CursorKind.CXX_METHOD.value,0,0,1, u'', 17, 0),
...
('c:@N@NS0@C@C1@F@check2#','check2',cur_dir+'/ns0.cpp',13,12,clang.cindex.CursorKind.CXX_METHOD.value,0,0,1, u'c:@N@NS0@C@C1', 105, 0),
('c:@N@NS0@F@asdf#','asdf',cur_dir+'/ns0.cpp',17,10,clang.cindex.CursorKind.FUNCTION_DECL.value,0,0,1, u'', 2, 0),
('c:ns0.cpp@356@N@NS0@F@asdf#I#@a','a',cur_dir+'/ns0.cpp',20,19,clang.cindex.CursorKind.PARM_DECL.value,0,0,1, u'', 17, 0),
('c:ns0.cpp@356@N@NS0@F@asdf#I#@a','a',cur_dir+'/ns0.cpp',21,30,clang.cindex.CursorKind.DECL_REF_EXPR.value,cur_dir+'/ns0.cpp',20,19),
],
# ns1.cpp
[
('c:@N@NS1','NS1',cur_dir+'/subdir/ns1.cpp',2,11,clang.cindex.CursorKind.NAMESPACE.value,0,0,1, u'', 0, 0),
('c:@N@NS1@C@C0','C0',cur_dir+'/subdir/ns1.cpp',3,10,clang.cindex.CursorKind.TYPE_REF.value,cur_dir+'/ns1.h',3,11),
('c:@N@NS1@C@C0@F@check#','check',cur_dir+'/subdir/ns1.cpp',3,14,clang.cindex.CursorKind.CXX_METHOD.value,0,0,1, u'', 2, 0),
...
('c:@N@NS1@C@C1@F@check#','check',cur_dir+'/subdir/ns1.cpp',7,14,clang.cindex.CursorKind.CXX_METHOD.value,0,0,1, u'', 2, 0),
