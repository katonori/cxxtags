...
decl_col = "usr_list.name, decl.name, file_list.name, decl.line, decl.col, decl.kind, decl.val, decl.is_virtual, decl.is_def FROM " + cxxtags.QUERY_JOINED_TABLE_DECL
...
overriden_col = "usr_list.name, overriden.name, file_list.name, overriden.line, overriden.col, overriden.kind, usr_list_overrider.name, overriden.is_def FROM " + cxxtags.QUERY_JOINED_TABLE_OVERRIDEN
...
(u'c:@C@C0@FI@mVal', u'mVal',cur_dir+'/main.cpp',6,17,clang.cindex.CursorKind.MEMBER_REF.value,u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 12, 9),
(u'c:main.cpp@65@C@C0@F@C0#I#@a', u'a', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 6, 22, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 6, 12),
(u'c:@C@C0@F@check#1', u'check', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 7, 10, clang.cindex.CursorKind.CXX_METHOD.value, 0, 0, 1),
(u'c:@F@printf', u'printf', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 9, 9, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/usr/include/stdio.h', 267, 6),
(u'c:@C@C0@FI@mVal', u'mVal', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 9, 31, clang.cindex.CursorKind.MEMBER_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 12, 9),
(u'c:@C@C0@FI@mVal', u'mVal', cur_dir+'/main.cpp',12,9,clang.cindex.CursorKind.FIELD_DECL.value,0,0,1),
(u'c:main.cpp@198', u'in_type', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 15, 20, clang.cindex.CursorKind.TEMPLATE_TYPE_PARAMETER.value, 0, 0, 1),
 (u'c:@FT@>1#Tfunc_test#t0.0#', u'func_test', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 16, 6, clang.cindex.CursorKind.FUNCTION_TEMPLATE.value, 0, 0, 1),
(u'c:main.cpp@198', u'in_type', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 16, 16, clang.cindex.CursorKind.TYPE_REF.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 15, 20),
(u'c:main.cpp@232@FT@>1#Tfunc_test#t0.0#@val', u'val', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 16, 24, clang.cindex.CursorKind.PARM_DECL.value, 0, 0, 1),
(u'c:@N@std', u'std', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 18, 5, clang.cindex.CursorKind.NAMESPACE_REF.value, u'/usr/include/c++/4.2.1/iostream', 48, 26),
...
(u'c:main.cpp@385@F@main@i', u'i', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 26, 20, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 26, 13),
(u'c:main.cpp@385@F@main@i', u'i', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 26, 27, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 26, 13),
(u'c:main.cpp@351@F@main@vecTest', u'vecTest', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 27, 9, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 25, 22),
(u'c:@N@std@C@vector>#$@C@C0#$@N@std@C@allocator>#S0_@F@push_back#&1S0_#', u'push_back', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 27, 17, clang.cindex.CursorKind.MEMBER_REF_EXPR.value, u'/usr/include/c++/4.2.1/bits/stl_vector.h', 600, 7),
...
(u'c:main.cpp@351@F@main@vecTest', u'vecTest', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 29, 42, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 25, 22),
(u'c:@N@std@C@vector>#$@C@C0#$@N@std@C@allocator>#S0_@F@begin#', u'begin', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 29, 50, clang.cindex.CursorKind.MEMBER_REF_EXPR.value, u'/usr/include/c++/4.2.1/bits/stl_vector.h', 330, 7),
(u'c:main.cpp@458@F@main@itr', u'itr', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 30, 9, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 29, 36),
(u'c:main.cpp@351@F@main@vecTest', u'vecTest', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 30, 16, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 25, 22),
(u'c:@N@std@C@vector>#$@C@C0#$@N@std@C@allocator>#S0_@F@end#', u'end', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 30, 24, clang.cindex.CursorKind.MEMBER_REF_EXPR.value, u'/usr/include/c++/4.2.1/bits/stl_vector.h', 348, 7),
(u'c:main.cpp@458@F@main@itr', u'itr', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 31, 9, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 29, 36),
(u'c:main.cpp@458@F@main@itr', u'itr', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 32, 9, clang.cindex.CursorKind.DECL_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 29, 36),
(u'c:@C@C0@F@check#1', u'check', u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 32, 14, clang.cindex.CursorKind.MEMBER_REF_EXPR.value, u'/Users/norito/devel/cxxtags/test/template_type_param/main.cpp', 7, 10),
]
